(function(global) {
  ...
  function Nav(options) {
    ...
    this.navToggle = this.nav.getElementsByClassName(this.settings.classPrefix + '-toggle')[0];
  ...
  Nav.prototype.getOnClick = function() {
    ...
    var onClick = function(e) {
      ...
      if (_hasClass(nav, _this.settings.classPrefix + '-open')) {
        _this.close();
      } else {
        _this.open();
      }
  ...
  Nav.prototype.enable = function() {
    ...
    this.navToggle.addEventListener('click', this.onClick);
  };
